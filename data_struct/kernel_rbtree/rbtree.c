/*
* An simple example of using linux kernel rb tree.
* Author: jeff
*/
...
{
	//19,34,21,6,90,87,32,22,12,2
	int lucky[10]={19,34,21,6,90,87,32,22,12,2};
	int i;
...
MODULE_DESCRIPTION("An simple example of using linux kernel rb tree");
MODULE_LICENSE("GPL");
module_init(re_init);
module_exit(re_exit);
