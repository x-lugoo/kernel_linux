cmd_/home/xl.lin/workspace/sample/sysnc/sync.o := ppc_6xx-gcc -m32 -Wp,-MD,/home/xl.lin/workspace/sample/sysnc/.sync.o.d  -nostdinc -isystem /opt/eldk/usr/bin/../lib/gcc/powerpc-linux/4.2.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Iarch/powerpc -gstabs+ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -O2 -msoft-float -pipe -Iarch/powerpc -ffixed-r2 -mmultiple -mno-altivec -mno-spe -funit-at-a-time -mno-string -mcpu=powerpc -Wa,-maltivec -fomit-frame-pointer  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(sync)"  -D"KBUILD_MODNAME=KBUILD_STR(sync)" -c -o /home/xl.lin/workspace/sample/sysnc/sync.o /home/xl.lin/workspace/sample/sysnc/sync.c

deps_/home/xl.lin/workspace/sample/sysnc/sync.o := \
  /home/xl.lin/workspace/sample/sysnc/sync.c \
...
/home/xl.lin/workspace/sample/sysnc/sync.o: $(deps_/home/xl.lin/workspace/sample/sysnc/sync.o)
